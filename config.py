...
[FocusStack]
	...
	def _load_from_file(self):
		...
		self.configValues["FocusStackLaunchPath"] = self.Config.get("FocusStack", "LaunchPath", fallback='"{{Install}}" --align-keep-size --jpgquality=100 --output="{{outputPath}}" "{{folderPath}}/"*jpg')
